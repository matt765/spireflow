  ...
  return (
    <>
      ...
      <div className="fixed w-screen h-screen flex justify-center items-center top-0 left-0 ">
        <div
          ref={modalRef}
          className="w-screen h-screen sm:w-[31rem] sm:h-auto bg-primaryBg dark:bg-primaryBgDark shadow-xl px-[6vw] xsm:px-[18vw] sm:px-16  pt-24 sm:pt-14 pb-12 flex flex-col items-center justify-start sm:rounded-2xl relative"
        >
          <button
            onClick={closeModal}
