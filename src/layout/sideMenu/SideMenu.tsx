...
export const SideMenu = () => {
  ...
  return (
    <div
      className={` hidden xl:flex flex-col h-full xl:w-[220px] xl:min-w-[220px] 2xl:min-w-[260px] bg-primaryBg dark:bg-primaryBgDark white pt-20 2xl:pt-20 transition-transform duration-300 ease-in-out ${
    ...
    >
      ...
      >
        ...
        <div
          className={` fixed  xl:w-[205px] xl:min-w-[205px] 2xl:min-w-[245px]  flex gap-4 bottom-0 left-0 justify-center items-center flex items-center justify-center pb-6 pl-4
